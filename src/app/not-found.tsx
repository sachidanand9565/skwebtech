...
export default function NotFound() {
  return (
    <section className="relative min-h-screen flex items-center justify-center bg-void overflow-hidden">
      ...
      <div className="glow-orb top-1/4 left-1/4 w-96 h-96 bg-primary-500/[0.08]" />
      <div className="glow-orb bottom-1/4 right-1/4 w-80 h-80 bg-secondary-500/[0.09]" style={{ animationDelay: '4s' }} />
            ...
            <div className="flex flex-wrap justify-center gap-3">
              {[
                ...
                <Link
                  key={href}
                  href={href}
                  className="px-4 py-2 rounded-full bg-white border border-slate-200 text-slate-700 text-sm font-medium hover:border-primary-500/40 hover:text-primary-600 transition-all"
                >
                  {label}
                </Link>
              ))}
