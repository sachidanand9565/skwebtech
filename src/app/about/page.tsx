  ...
  return (
    <>
      ...
      <section className="relative pt-28 md:pt-36 pb-20 bg-void overflow-hidden">
        ...
        <div className="glow-orb bottom-0 right-1/4 w-72 h-72 bg-secondary-500/[0.09]" style={{ animationDelay: '4s' }} />
            ...
            <StaggerContainer className="grid grid-cols-2 gap-4">
              {stats.map(({ value, label, icon: Icon }) => (
                <StaggerItem key={label}>
                  <div className="rounded-2xl border border-slate-200 bg-white p-6 backdrop-blur-sm transition-colors duration-300 hover:border-primary-500/30">
            ...
            <Reveal x={-24} y={0}>
              <div className="relative h-full overflow-hidden rounded-3xl border border-primary-500/20 bg-gradient-to-br from-primary-950/80 to-void-100 p-10 border-glow">
                ...
                <div className="relative z-10">
                  ...
                  <h2 className="text-2xl md:text-3xl font-heading font-bold mb-4 text-slate-900">Our Mission</h2>
            ...
            <Reveal x={24} y={0} delay={0.1}>
              <div className="relative h-full overflow-hidden rounded-3xl border border-secondary-500/20 bg-gradient-to-br from-secondary-950/80 to-void-100 p-10 border-glow">
                ...
                <div className="relative z-10">
                  ...
                  <h2 className="text-2xl md:text-3xl font-heading font-bold mb-4 text-slate-900">Our Vision</h2>
                  <p className="text-slate-700 leading-relaxed text-lg">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
            <Reveal x={-24} y={0}>
              <div className="relative">
                ...
                <div className="relative aspect-[4/5] max-w-md mx-auto lg:mx-0 rounded-3xl overflow-hidden border border-slate-200 shadow-soft-lg">
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-4 mb-8">
                  {[{ v: '4+', l: 'Years Experience' }, { v: '80+', l: 'Projects Led' }].map(({ v, l }) => (
                    <div key={l} className="rounded-2xl border border-slate-200 bg-white p-5 backdrop-blur-sm">
                ...
                <div className="flex flex-wrap gap-3">
                  ...
                  <a href="mailto:info@skwebtech.in"
                    className="inline-flex items-center gap-2 px-4 py-2.5 bg-white border border-slate-300 text-slate-900 text-sm font-medium rounded-xl hover:bg-white/[0.12] hover:-translate-y-0.5 transition-all">
                    <Mail size={16} /> Email
                  </a>
                </div>
              </div>
      ...
      <section className="relative py-10 md:py-10 bg-void">
        <div className="container-custom">
          <div className="text-center mb-14">
            ...
            <Reveal delay={0.08}>
              <h2 className="text-3xl md:text-4xl font-heading font-bold text-slate-900">What Drives Us</h2>
            </Reveal>
            <Reveal delay={0.16}>
              <p className="text-slate-600 mt-3 max-w-xl mx-auto">Our core values guide every decision we make and every project we undertake.</p>
            </Reveal>
          </div>
          <StaggerContainer className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {coreValues.map((value) => (
              <StaggerItem key={value.title} className="h-full">
                <div className="group h-full rounded-2xl border border-slate-200 bg-white p-7 backdrop-blur-sm transition-all duration-300 ease-out-expo hover:-translate-y-1 hover:border-primary-500/30 hover:shadow-card-hover">
                  ...
                  <h3 className="text-lg font-heading font-bold text-slate-900 mb-2">{value.title}</h3>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
            <Reveal x={-24} y={0}>
              <div>
                ...
                <h2 className="text-3xl md:text-4xl font-heading font-bold text-slate-900 mb-4">Why Businesses Choose Us</h2>
                <p className="text-slate-600 leading-relaxed mb-8">We combine technical excellence with a client-first approach to deliver solutions that truly make a difference.</p>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  {whyUs.map((reason) => (
                    <div key={reason} className="flex items-center gap-3 rounded-xl border border-slate-200 bg-white p-3.5 backdrop-blur-sm transition-colors duration-300 hover:border-primary-500/25">
            ...
            <Reveal x={24} y={0} delay={0.1}>
              <div className="relative overflow-hidden rounded-3xl border border-slate-200 bg-void-100/80 p-8 border-glow">
                <div className="glow-orb top-0 right-0 w-40 h-40 bg-primary-500/[0.14]" />
                <div className="absolute inset-0 bg-dots opacity-20 pointer-events-none" />
                <div className="relative z-10">
                  <h3 className="text-2xl font-heading font-bold mb-3 text-slate-900">Global Reach, Personal Touch</h3>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    {[{ v: '80+', l: 'Projects' }, { v: '100+', l: 'Clients' }, { v: '15+', l: 'Countries' }, { v: '24/7', l: 'Support' }].map(({ v, l }) => (
                      <div key={l} className="rounded-2xl border border-slate-200 bg-white p-4 text-center">
      ...
      <section className="relative py-10 md:py-10 bg-void">
        <div className="container-custom">
          <div className="text-center mb-14">
            ...
            <Reveal delay={0.08}>
              <h2 className="text-3xl md:text-4xl font-heading font-bold text-slate-900">Growing Year by Year</h2>
            </Reveal>
          </div>
