    ...
    <>
        ...
        <div className="container-custom max-w-4xl">
          <div className="rounded-3xl border border-amber-500/25 bg-amber-500/[0.05] p-6 flex items-start gap-4">
            ...
            <p className="text-slate-700 text-sm leading-relaxed">
              <span className="font-semibold text-slate-900">In short:</span> advance payments are adjustable against work done, completed milestones are non-refundable, and third-party costs (domains, hosting, API charges) can never be refunded. If we fail to start or deliver from our side, you get your money back.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="pb-14 bg-void">
        <div className="container-custom max-w-4xl">
          ...
          <div className="mt-10 flex flex-wrap gap-3 justify-center">
            <Link href="/terms-and-conditions" className="inline-flex items-center gap-2 px-5 py-2.5 bg-white border border-slate-200 text-slate-700 text-sm font-medium rounded-full hover:border-primary-500/40 hover:text-primary-600 transition-all">
      ...
      <section className="relative py-10 bg-void overflow-hidden">
        ...
        <div className="container-custom max-w-3xl text-center relative z-10">
          ...
          <h2 className="text-3xl font-heading font-bold text-slate-900 mb-4">Need Help With a Refund?</h2>
