  ...
  return (
    <section className="relative py-10 md:py-14 bg-void overflow-hidden">
      ...
      <div className="container-custom relative z-10">
        ...
        {/* Feature Cards */}
        <StaggerContainer className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mt-10 mb-10">
          {features.map((feature) => (
            <StaggerItem key={feature.title} className="h-full">
              <div className="group h-full rounded-2xl border border-slate-200 bg-white p-7 backdrop-blur-sm transition-all duration-300 ease-out-expo hover:-translate-y-1.5 hover:border-primary-500/30 hover:bg-slate-50 hover:shadow-card-hover">
        ...
        {/* Trust Banner */}
        <Reveal>
          <div className="relative overflow-hidden rounded-3xl border border-slate-200 bg-void-100/80 p-8 md:p-12 border-glow">
            ...
            <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
              <div>
                ...
                <div className="flex flex-wrap gap-3">
                  {highlights.map((h) => (
                    <div key={h} className="flex items-center gap-2 px-3 py-2 bg-white border border-slate-200 rounded-xl backdrop-blur-sm">
              ...
              <div className="grid grid-cols-2 gap-4">
                {bannerStats.map(({ v, l, icon: Icon }) => (
                  <div key={l} className="rounded-2xl border border-slate-200 bg-white p-5 text-center backdrop-blur-sm transition-colors duration-300 hover:border-primary-500/30">
